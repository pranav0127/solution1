<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="Kids.aspx.cs" Inherits="Kids" %>
...
<br />
<br /><br />
<h3>Welcome to Kids's Section</h3>
    <hr /><br /><br />
    <div class="row" style="padding-top:50px">
    <asp:Repeater ID="rptrKidsProducts" runat="server">
        <ItemTemplate>
