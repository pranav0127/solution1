<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="Men.aspx.cs" Inherits="Men" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <br />
<br /><br />
<h3>Welcome to Men's Section</h3>
    <hr /><br /><br />
    <div class="row" style="padding-top:50px">
    <asp:Repeater ID="rptrMenProducts" runat="server">
        <ItemTemplate>
